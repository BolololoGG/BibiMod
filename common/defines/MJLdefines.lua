...
NDefines.NDiplomacy.MAX_CLIENT_STATES = 8 -- PR MOD
...
NDefines.NCountry.CONCENTRATE_DEVELOPMENT_COOLDOWN_DURATION = 500
...
NDefines.NEconomy.PIRATES_TRADE_POWER_FACTOR = 0.9
